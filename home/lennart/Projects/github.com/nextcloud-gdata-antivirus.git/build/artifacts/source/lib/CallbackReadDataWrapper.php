...
use OCA\GDataVaas\Vendor\Icewind\Streams\CallbackWrapper;
use OCA\GDataVaas\Vendor\Icewind\Streams\Wrapper;
class CallbackReadDataWrapper extends CallbackWrapper
{
    ...
    {
        $context = stream_context_create(['callbackReadData' => ['source' => $source, 'readData' => $read, 'write' => $write, 'close' => $close, 'readDir' => $readDir, 'preClose' => $preClose]]);
