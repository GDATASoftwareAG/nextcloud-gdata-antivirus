...
use OCA\GDataVaas\Vendor\OC\Files\Filesystem;
...
class Application extends App implements IBootstrap
{
    ...
    {
        require_once file_exists(__DIR__ . '/../../vendor/scoper-autoload.php') ? __DIR__ . '/../../vendor/scoper-autoload.php' : __DIR__ . '/../../vendor/autoload.php';
    ...
    {
        Filesystem::addStorageWrapper('oc_gdata_vaas', function (string $mountPoint, IStorage $storage) {
            /*
