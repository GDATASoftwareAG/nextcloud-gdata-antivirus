...
class CacheEntryListener implements IEventListener
{
    ...
    {
        $context->registerEventListener(CacheEntryInsertedEvent::class, \OCA\GDataVaas\CacheEntryListener::class);
        $context->registerEventListener(CacheEntryUpdatedEvent::class, \OCA\GDataVaas\CacheEntryListener::class);
    }
