...
class NotifyAdminJob extends TimedJob
{
    ...
    public function __construct(ITimeFactory $time, IAppConfig $appConfig, TagService $tagService, DbFileMapper $dbFileMapper, LoggerInterface $logger, MailService $mailService, FileService $fileService)
    {
